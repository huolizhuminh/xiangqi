...
public abstract class Button extends CustomView {
	...
	protected void setDefaultProperties() {
		// Min size
		setMinimumHeight(GameUtils.dpToPx(minHeight, getResources()));
		setMinimumWidth(GameUtils.dpToPx(minWidth, getResources()));
		// Background shape
	...
	public Bitmap makeCircle() {
		Bitmap output = Bitmap.createBitmap(
				getWidth() - GameUtils.dpToPx(6, getResources()), getHeight()
						- GameUtils.dpToPx(7, getResources()), Config.ARGB_8888);
