package com.minhuizhu.mynewchess.widget.common;
...
import com.minhuizhu.common.util.GameUtils;
...
public class Slider extends CustomView {
            ...
            if (event.getAction() == MotionEvent.ACTION_DOWN
                ...
                if ((event.getX() <= getWidth() && event.getX() >= 0)) {
                    ...
                    if (event.getX() > ball.xFin) {
                        ...
                        newValue = min + (int) ((event.getX() - ball.xIni) / division + 0.5);
                    }
                    if (value != newValue) {
                        value = newValue;
                    ...
                    if (numberIndicator != null) {
                        ...
                        numberIndicator.indicator.finalY = GameUtils
                ...
                float division = (ball.xFin - ball.xIni) / (max - min);
                float endx = ball.xIni + (value - min) * division;
                ViewHelper.setX(ball, endx);
                ball.changeBackground();
                if (numberIndicator != null)
                    numberIndicator.dismiss();
                isLastTouch = false;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (value == min) {
            ...
            paint.setStrokeWidth(GameUtils.dpToPx(2, getResources()));
    ...
    protected void setAttributes(AttributeSet attrs) {
        ...
        // Set size of view
        setMinimumHeight(GameUtils.dpToPx(48, getResources()));
        setMinimumWidth(GameUtils.dpToPx(80, getResources()));
        ...
        LayoutParams params = new LayoutParams(GameUtils.dpToPx(20,
                getResources()), GameUtils.dpToPx(20, getResources()));
    ...
    class Indicator extends RelativeLayout {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (animate) {
                ...
                y -= GameUtils.dpToPx(6, getResources());
                size += GameUtils.dpToPx(2, getResources());
            }
            canvas.drawCircle(
                    ViewHelper.getX(ball)
                            + GameUtils.getRelativeLeft((View) ball.getParent())
            ...
            if (animate == false) {
                ViewHelper
                        .setX(numberIndicator.numberIndicator,
                                (ViewHelper.getX(ball)
                                        + GameUtils.getRelativeLeft((View) ball
